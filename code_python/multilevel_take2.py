...
len_t_unique = len(t_unique)
len_idx_unique = len(idx_unique)

len_t_unique
len_idx_unique

t_train.reshape((15, 10)).T  # timesteps. 
idx_train.reshape((15, 10)).T # idx 

new_y = y_train.reshape((15, 10)).T
...
with pm.Model(coords = coords2) as m2: 
    ...
    idx_shared = pm.Data('idx_shared', idx_train, dims = "t")
    ...
    # likelihood
    y_pred = pm.Normal("y_pred", mu = mu, sigma = sigma, observed = y_train, dims = ("t"))
